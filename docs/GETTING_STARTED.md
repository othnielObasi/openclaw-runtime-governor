...
```bash
curl -s -X POST http://45.76.141.204/actions/evaluate \
...
|-----------|----------|-----|
| Backend (primary) | Fly.io | `http://45.76.141.204` |
| Backend (standby) | Vultr VPS | `http://45.76.141.204` |
...
3. Set env var: `NEXT_PUBLIC_GOVERNOR_API=http://45.76.141.204`
4. Deploy
