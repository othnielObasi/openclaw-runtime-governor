...
@router.get("/assess")
async def full_assessment(period: str = Query("30d", pattern="^(24h|7d|30d|90d|all)$")):
...
async def agent_assessment(agent_id: str,
                           period: str = Query("30d", pattern="^(24h|7d|30d|90d|all)$")):
...
@router.get("/agents")
async def list_agents(period: str = Query("all", pattern="^(24h|7d|30d|90d|all)$")):
...
@router.get("/tools")
async def list_tools(period: str = Query("all", pattern="^(24h|7d|30d|90d|all)$")):
