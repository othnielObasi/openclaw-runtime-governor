...
function SpanRow({
  ...
  return (
    ...
    >
      {/* Tree connector */}
      {node.depth > 0 && (
        <span style={{ color: C.line2, fontFamily: mono, fontSize: 10, userSelect: "none" }}>
          {"└"}
        </span>
      )}
      ...
      {/* Status */}
      {s.status === "error" && (
        <span style={{ fontFamily: mono, fontSize: 8, color: C.red }}>ERROR</span>
      )}
  ...
  return (
    <div style={{ padding: 14, overflow: "auto", maxHeight: "100%" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
        ...
        <span style={{ fontFamily: mono, fontSize: 12, color: C.p1, fontWeight: 700 }}>
          {span.name}
        </span>
      </div>
            ...
            {govTrace.map((step: any, i: number) => {
              ...
              return (
                ...
                >
                  ...
                  {step.risk > 0 && (
                    <span style={{ color: C.red, fontSize: 8 }}>RISK {step.risk}</span>
                  )}
                  <span style={{ color: C.p3, fontSize: 8 }}>{fmtMs(step.duration_ms)}</span>
                </div>
              );
            })}
          </div>
      ...
      >
        {selectedTrace ? (
          <>
            ...
            <span style={{ fontFamily: mono, fontSize: 11, color: C.p1, fontWeight: 700 }}>
              TRACE
            </span>
          ...
          <>
            ...
            <span style={{ fontFamily: mono, fontSize: 9, color: C.p3, marginLeft: "auto" }}>
                    ...
                    <td style={{ padding: "6px 10px" }}>
                      <span style={{ display: "flex", gap: 4 }}>
                        ...
                        {!t.has_blocks && !t.has_errors && (
                          <span style={{ fontSize: 7, color: C.green }}>OK</span>
                        )}
                      </span>
                    </td>
              ...
              <div style={{ padding: "10px 14px" }}>
                ...
                {selectedTrace.governance_decisions.map((d) => (
                  ...
                  >
                    ...
                    <span style={{ color: C.p3, fontSize: 8 }}>
                      risk {d.risk_score}
                    </span>
                    <span
                      style={{ color: C.p3, flex: 1, textAlign: "right", fontSize: 8 }}
                    >
