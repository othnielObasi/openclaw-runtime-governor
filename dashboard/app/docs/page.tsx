...
function Table({ headers, rows }: { headers: string[]; rows: string[][] }) {
  return (
    <div style={{ overflowX: "auto", marginBottom: 20 }}>
      <table style={{
        width: "100%", borderCollapse: "collapse", fontFamily: mono, fontSize: 12.5,
      }}>
        <thead>
          <tr>
            {headers.map((h, i) => (
        ...
        <tbody>
          {rows.map((row, ri) => (
            <tr key={ri} style={{
              background: ri % 2 === 0 ? "transparent" : `${C.bg1}66`,
            }}>
              {row.map((cell, ci) => (
                <td key={ci} style={{
...
function Badge({ children, color = C.p3 }: { children: string; color?: string }) {
  return (
    <span style={{
      fontFamily: mono, fontSize: 10, letterSpacing: 1,
        ...
        <React.Fragment key={l.n}>
          {i > 0 && (
            <div style={{
              ...
              <span style={{ color: C.p3, fontSize: 14 }}>→</span>
            </div>
          )}
          <div style={{
            ...
            <div style={{
              fontFamily: mono, fontSize: 12, fontWeight: 600, color: l.color,
            }}>
              {l.icon} {l.name}
            </div>
            <div style={{
              fontFamily: sans, fontSize: 11, color: C.p3, lineHeight: 1.4,
            }}>
              {l.desc}
            </div>
          </div>
...
export default function DocsPage() {
  ...
  return (
    <div style={{
      background: C.bg0, color: C.p1, fontFamily: sans,
      minHeight: "100vh", display: "flex", flexDirection: "column",
    }}>
      {/* ═══ GLOBAL STYLES ═══ */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@300;400;500;600;700&family=DM+Sans:wght@300;400;500;700&display=swap');
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
              width: 30, height: 30, border: `1.5px solid ${C.accent}`,
              display: "flex", alignItems: "center", justifyContent: "center",
              fontFamily: mono, fontSize: 9, color: C.accent, letterSpacing: 0.5,
              position: "relative",
            }}>
              OCG
              <div style={{ position: "absolute", inset: 3, border: `1px solid ${C.accent}44` }} />
            </div>
            <span style={{
          ...
          <div style={{ width: 1, height: 24, background: C.line, margin: "0 6px" }} />

          <span style={{
            fontFamily: mono, fontSize: 10.5, color: C.p3, letterSpacing: 1.5,
          }}>
            GETTING STARTED
          </span>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <Link href="/" style={{
            ...
            padding: "6px 14px", border: `1px solid ${C.accent}`,
      ...
      <div style={{ display: "flex", flex: 1 }}>
        ...
        <nav style={{
          ...
          <div style={{ padding: "0 16px 16px" }}>
            <div style={{
              ...
              <span style={{ color: C.p3, fontSize: 13 }}>⌕</span>
              <input
                type="text"
                ...
                style={{
                  ...
                  fontFamily: mono, fontSize: 12, color: C.p1, width: "100%",
                  letterSpacing: 0.5,
                }}
              />
            </div>
          ...
          {/* Bottom meta */}
          <div style={{
            padding: "16px 20px", borderTop: `1px solid ${C.line}`,
            fontFamily: mono, fontSize: 10, color: C.p3, letterSpacing: 1,
          }}>
            <div>246 TESTS · 17 TABLES</div>
            <div style={{ marginTop: 4 }}>80 ROUTES · 16 TABS</div>
        ...
        <main ref={contentRef} style={{
          flex: 1, padding: "40px 48px 80px", maxWidth: 900,
          ...
          <div style={{ marginBottom: 48 }}>
            ...
            <h1 style={{
              fontFamily: mono, fontSize: 32, fontWeight: 700, color: C.p1,
...
const sans = "'DM Sans', sans-serif";`}</CodeBlock>
      ...
      {/* ═══ MOBILE TOC TOGGLE (shows below 768px conceptually, always visible as fallback) ═══ */}
      <button
        onClick={() => {
